...
export default function SessionTables({
	...
	const handleStartEdit = async (session: Session) => {
		...
		const schoolId = schoolOption ? schoolOption.value : "";
	...
	const handleEditChange = (key: string, value: any) => {
		if (editingData) {
			...
			// Optionally notify parent of changes in real-time if needed
			// This is commented out because it might be too chatty
			// if (onEditingChange) {
			//   onEditingChange(true, updatedData);
			// }
		}
	};
