            ...
            >
              ...
              <div className="flex justify-end gap-3 mt-8">
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  onClick={onClose}
                  className="px-4 py-2 text-gray-600 hover:text-gray-800 font-medium bg-gray-50 rounded-full"
                >
                  Reset
                </motion.button>
                <motion.button
                  ...
                  className="px-6 py-2 bg-emerald-700 text-white rounded-full hover:bg-emerald-800 transition-colors font-medium"
                >
                  Save Changes
                </motion.button>
              </div>
