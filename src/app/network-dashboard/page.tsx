...
export default function NetworkDashboard() {
  ...
  useEffect(() => {
    ...
    if (typeof window !== "undefined") {
      ...
      setNetworkName(localStorage.getItem("networkname"));
    }
  }, []);
  ...
  const showSessionDetails =
    viewingClassrooms !== null && activeTab === "Sessions";
      ...
      {showSessionDetails ? (
          ...
          <div className="flex items-center mb-2 bg-gray-100 p-2 rounded-xl">
            <div className="flex items-center gap-3">
              <CalendarDate
                date={
                  ...
                  selectedSchoolData?.date ||
                  new Date()
                }
              />
              <h1 className="text-base font-semibold">
                {viewingClassrooms?.school ||
            ...
            <div className="ml-auto right-0 px-3 py-1 rounded-full bg-blue-100 text-blue-800 text-sm font-medium">
              {viewingClassrooms?.observation_tool ||
                selectedSchoolData?.observationTool ||
                "Tool"}
            </div>
          </div>
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600">
            View and compare data across all districts under your purview.
            Quickly access insights into observation activity, districts, and
            tool usage.
          </p>
